    ...
    return {
        ...
        content: item.content.map((content) => {
            ...
            if (content.type === 'input_image') {
                ...
                throw new agents_core_1.UserError('Compaction input_image item missing image_url or file_id.');
            }
            if (content.type === 'input_file') {
                ...
                throw new agents_core_1.UserError('Compaction input_file item missing file_data, file_url, or file_id.');
            }
            throw new agents_core_1.UserError(`Unsupported compaction message content type: ${JSON.stringify(content)}`);
        }),
    };
}
